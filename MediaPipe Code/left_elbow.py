...
def save_data_to_json(data):
    with open('left_elbow_angle_data.json', 'w') as json_file:
...
while cap.isOpened():
    ...
    if results.pose_landmarks:
        ...
        # Assuming that landmark 11 is the left elbow and landmark 13 is the left wrist
        # Assuming that landmark 12 is the left shoulder
        left_elbow = [landmarks[11].x, landmarks[11].y]
        left_wrist = [landmarks[13].x, landmarks[13].y]
